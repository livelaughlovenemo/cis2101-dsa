...
int main() {
    ...
    printf("Searching for RGB (%d, %d, %d) in bucket [%d]...\n",
       searchRedRGB[0], searchRedRGB[1], searchRedRGB[2],
       hashFunction(searchRedRGB));
    ...
    printf("Searching for RGB (%d, %d, %d) in bucket [%d]...\n",
       searchSlightlyRed[0], searchSlightlyRed[1], searchSlightlyRed[2],
       hashFunction(searchSlightlyRed));
    ...
    printf("Searching for RGB (%d, %d, %d) in bucket [%d]...\n",
       searchOrangeRGB[0], searchOrangeRGB[1], searchOrangeRGB[2],
       hashFunction(searchOrangeRGB));
